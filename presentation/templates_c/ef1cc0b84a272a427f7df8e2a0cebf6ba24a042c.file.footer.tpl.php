<?php /* Smarty version Smarty-3.1.15, created on 2016-03-29 17:21:24
         compiled from "D:\xampp\htdocs\araam\presentation\templates\footer.tpl" */ ?>
<?php /*%%SmartyHeaderCode:609856e0fa08674047-86343678%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ef1cc0b84a272a427f7df8e2a0cebf6ba24a042c' => 
    array (
      0 => 'D:\\xampp\\htdocs\\araam\\presentation\\templates\\footer.tpl',
      1 => 1459254075,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '609856e0fa08674047-86343678',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_56e0fa08848cb8_45397502',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56e0fa08848cb8_45397502')) {function content_56e0fa08848cb8_45397502($_smarty_tpl) {?></div>
</div>
<div id="footer-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <p><a href="index.php" class="brand"><img src="<?php echo $_smarty_tpl->getConfigVariable('site_root');?>
/web/img/logo.png" /></a></p>
        ...
        <div class="row">
            <div id="footer" class="clearfix">
                ...
                <div class="col-md-6 pull-right">
                    ...
                    <!--<p>
                        Become a Fan: <img src="<?php echo $_smarty_tpl->getConfigVariable('site_root');?>
/web/img/facebook.png" /> 
                        Follow Us on: <img src="<?php echo $_smarty_tpl->getConfigVariable('site_root');?>
/web/img/twitter.png" />
                    </p>-->
                </div>
            </div>
...
<script src="<?php echo $_smarty_tpl->getConfigVariable('site_root');?>
/web/js/jquery-ui.min.js"></script>

<script src="<?php echo $_smarty_tpl->getConfigVariable('site_root');?>
/web/js/bootstrap.js"></script>
<!--<script src="<?php echo $_smarty_tpl->getConfigVariable('site_root');?>
/web/js/bootstrap-modal.js"></script>-->
...
<script src="<?php echo $_smarty_tpl->getConfigVariable('site_root');?>
/web/js/jquery.autocomplete.min.js" type="text/javascript" ></script>
<?php echo $_smarty_tpl->getSubTemplate ("autocomplete.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

<!--script src="<?php echo $_smarty_tpl->getConfigVariable('site_root');?>
/web/js/currency-autocomplete.js" type="text/javascript" ></script-->
...
<!-- FlexSlider -->
<!--
<script defer src="<?php echo $_smarty_tpl->getConfigVariable('site_root');?>
/web/js//jquery.flexslider.js"></script>

<script src="<?php echo $_smarty_tpl->getConfigVariable('site_root');?>
/web/js/jquery.poshytip.js"></script>
...
<script type="text/javascript" src="<?php echo $_smarty_tpl->getConfigVariable('site_root');?>
/web/js/jquery.nivo.slider.js"></script>
<script type="text/javascript">
...
<script type="text/javascript" src="<?php echo $_smarty_tpl->getConfigVariable('site_root');?>
/web/js/parsley.js"></script>

<script type="text/javascript" src="<?php echo $_smarty_tpl->getConfigVariable('site_root');?>
/web/js/jquery.jcarousel.min.js"></script>
