...
<div class="row">
    ...
    <div class="col-md-9">
        <h2>Contractor</h2>
        <form method="post" action="index.php?admin/contractor&action={$path}">
            <table class="table">
                ...
                <tr><td class="td_title">Website</td><td><input type="text" name="website" id="website" maxlength="254" value="{$d.website}"></td></tr>
