    ...
    <div class="col-md-9">
            ...
            <table class="table">
                ...
                {foreach from=$data key=myId item=i}
                    <tr>
                        <td><a href="index.php?admin/service&id={$i.id}&action=edit">Edit</a> <a href="index.php?admin/service&id={$i.id}&action=delete">Delete</a></td>
                        <td>{$i.id}</td>
                        <td>{$i.service}</td>
            ...
            <div class="pagination col-md-6">
                ...
                {for $foo=1 to $pagination.pages}
                    ...
                    {else}
                        ...
                        <a href="index.php?admin/service&page={$foo}">{$foo}</a> 
