...
<div class="row">
    ...
    <div class="col-md-9">
        <h2>Sub Area</h2>
        <form method="post" action="index.php?admin/subarea&action={$path}">
            <table class="table">
                <tr><td class="td_title">Id</td><td><input type="text" name="id" id="id" maxlength="11" value="{$d.id}" readonly=""></td></tr>
                <tr><td class="td_title">Sub Area Name</td><td><input type="text" name="subarea" id="subarea" maxlength="254" value="{$d.subarea}"></td></tr>
