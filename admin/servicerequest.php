...
switch ($action) {
    case 'display':
        ...
        $smarty->display('admin/servicerequest.tpl');
    ...
    case 'add':
        if (isset($_POST["submit01"])) {
            ...
            $smarty->assign("message", "");
            $smarty->display('admin/servicerequestupdate.tpl');
        }
        break;
    case 'edit':
        ...
        if (isset($_POST["submit01"])) {
            ...
            header("Location: index.php?admin/servicerequest");
        } else {
            $id = $getVars["id"];
